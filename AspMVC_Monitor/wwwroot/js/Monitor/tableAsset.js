export function AssetsTablePrepareCell(cell) {
    if (cell == null) {
        return;
    }
...
export function AssetsTableGetValueElement(cell) {
    if (cell == null) {
        return;
    }
...
export function AssetTagBackgroundStatusUpdate(cell, value, inAlarm) {
...
export function AssetsStatusBarUpdate(okCnt, alarmCnt) {
...
export function AssetsTableText(elem, value) {
    if (elem == null) {
        return;
    }
    var div = document.createElement('div');
...
export function AssetsTableTextUpdate(elem, value) {
    if (elem == null) {
        return;
    }
...
export function AssetsTableDotForBoolean(elem, state) {
    if (elem == null) {
        return;
    }
    elem.innerHTML = '';
...
export function ValueBarForNumber(elem, value, rangeMax, rangeMin) {
    if (elem == null) {
        return;
    }
    elem.innerHTML = '';
