...
namespace AssetMonitorDataAccess.Migrations
{
    ...
    [Migration("20220206153941_IsHistorized_Types")]
    partial class IsHistorized_Types
    {
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.AgentTag", b =>
                {
                    ...
                    b.Property<bool>("IsHistorizedAvg")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsHistorizedLast")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsHistorizedMax")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsHistorizedMin")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AgentDataTypeId = 1,
                            AgentTagSetId = 1,
                            IsHistorizedAvg = true,
                            IsHistorizedLast = false,
                            IsHistorizedMax = true,
                            IsHistorizedMin = false,
