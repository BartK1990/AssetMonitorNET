...
namespace AssetMonitorDataAccess.Migrations
{
    ...
    [Migration("20220312131109_TagShared_Enable")]
    partial class TagShared_Enable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.ApplicationProperty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Scan time of ICMP data Service",
                            Name = "AssetsTimedIcmpDataScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 2,
                            Description = "Scan time of Agent/Performance data Service",
                            Name = "AssetsTimedPerformanceDataScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 3,
                            Description = "Scan time of SNMP data Service",
                            Name = "AssetsTimedSnmpDataScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 4,
                            Description = "Scan time of Notifications Service",
                            Name = "AssetsNotificationTimedScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 5,
                            Description = "Scan time of Alarms Service",
                            Name = "AssetsAlarmTimedScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 6,
                            Description = "Scan time of Historical data Service",
                            Name = "AssetsHistoryTimedScanTime",
                            ValueDataTypeId = 2
                        },
                        new
                        {
                            Id = 7,
                            Description = "Scan time for reading data from main Windows Service",
                            Name = "FrontEndScanTime",
                            ValueDataTypeId = 2
                        });
                });

            modelBuilder.Entity("AssetMonitorDataAccess.Models.ApplicationPropertyDataType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ApplicationPropertyDataType");
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.ApplicationPropertyValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("ApplicationPropertyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ApplicationPropertyId")
                        .IsUnique();

                    b.ToTable("ApplicationPropertyValue");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            ApplicationPropertyId = 5,
                            Value = "10"
                        },
                        new
                        {
                            Id = 2,
                            ApplicationPropertyId = 6,
                            Value = "10"
                        },
                        new
                        {
                            Id = 3,
                            ApplicationPropertyId = 4,
                            Value = "10"
                        },
                        new
                        {
                            Id = 4,
                            ApplicationPropertyId = 1,
                            Value = "10"
                        },
                        new
                        {
                            Id = 5,
                            ApplicationPropertyId = 2,
                            Value = "10"
                        },
                        new
                        {
                            Id = 6,
                            ApplicationPropertyId = 3,
                            Value = "10"
                        },
                        new
                        {
                            Id = 7,
                            ApplicationPropertyId = 7,
                            Value = "10"
                        });
                });
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.AssetPropertyValue", b =>
                {
                    ...
                    b.HasIndex("AssetId", "AssetPropertyId")
                        .IsUnique();
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.AssetTagRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.ApplicationProperty", b =>
                {
                    b.HasOne("AssetMonitorDataAccess.Models.ApplicationPropertyDataType", "ValueDataType")
                        .WithMany()
            ...
            modelBuilder.Entity("AssetMonitorDataAccess.Models.ApplicationPropertyValue", b =>
                {
                    b.HasOne("AssetMonitorDataAccess.Models.ApplicationProperty", "ApplicationProperty")
                        .WithOne("ApplicationPropertyValue")
                        .HasForeignKey("AssetMonitorDataAccess.Models.ApplicationPropertyValue", "ApplicationPropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
